                                        ...
                                        <div class="mx-auto py-2 rounded form-group row"
                                            ...
                                            <div class="col-4 col-lg-2 form-group">
                                                ...
                                                <input type="hidden" class="price"
                                                    name="editProduct[{{ $loop->index }}][price]"
                                                    value="{{ number_format(round($price)) }}" class="hargaNonRetail">
                                            ...
                                            @php
                                                ...
                                                $price_disc =
                                                    (float) ($price - $disc_cost - $detail->discount_rp) * $detail->qty;
                                            @endphp
                                            <div class="col-4 col-lg-2 form-group">
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", ".modal-btn", function() {
                    ...
                    $(modal_id).on('click', '.btn-reload', function() {
                        ...
                        $(this).closest('.row').siblings('.formSo-edit').find('.productSo-edit').each(
                            function() {
                                let product_id = $(this).val();
