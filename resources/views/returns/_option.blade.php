...
<div class="currentModal">
                            ...
                            <div class="font-weight-bold">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-12 col-lg-6">
                                        ...
                                        <input type="text"
                                            value="{{ date('d F Y', strtotime($return->return_date)) }}" readonly
                                            class="form-control">
                                    </div>
                                    ...
                                    @foreach ($return->returnDetailsBy as $item)
                                        <div class="row rounded mx-auto pt-2 mb-3" style="background-color: #f0e194">
                                            ...
                                            @php
                                                ...
                                                $hargaDiskon = $diskon;
                                                $hargaAfterDiskon = $hargaDiskon - $diskon_rp;
                                            ...
                                            <div class="col-6 col-lg-3 form-group">
                                                ...
                                                <input type="text" class="form-control" readonly
                                                    value="{{ number_format($sub_total, 0, '.', ',') }}"
                                                    id="">
                                            </div>
    ...
    <div class="modal" id="editReturn{{ $return->id }}" data-bs-keyboard="false"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" id="formReturn">
                                        @foreach ($return->returnDetailsBy as $item)
                                            <div class="row rounded pt-2 mb-3 mx-auto"
                                                style="background-color: #f0e194">
                                                <input type="hidden" class="loop" value="{{ $loop->index }}">
                                                <div class="form-group col-12 col-lg-7">
                                                    <label>Product</label>
                                                    <select multiple
                                                        name="returnFields[{{ $loop->index }}][product_id]"
