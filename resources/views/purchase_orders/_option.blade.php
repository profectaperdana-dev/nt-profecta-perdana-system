...
Purchase Order by Email</a> --}}
    <div class="modal" id="delete{{ $purchase->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ url('return_purchase/' . $purchase->id) }}">Return
                                        Purchase</a></li>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 form-group mr-5">
                                            ...
                                            <select name="payment_method" required multiple
                                                ...
                                                <option value="cash"
                                                    @if ($purchase->payment_method == 'cash') selected @endif>
                                                    Cash</option>
                                                <option value="credit"
                                                    @if ($purchase->payment_method == 'credit') selected @endif>
                                                    Credit</option>
                                            </select>
                                        ...
                                        @foreach ($purchase->purchaseOrderDetailsBy as $detail)
                                            <div class="form-group rounded row pt-2 mb-3 mx-auto"
                                                ...
                                                <div class="col-2 col-lg-1 form-group">
                                                    <label>Qty</label>
                                                    <input type="number" class="form-control qtyPo jumlahQty"
                                                        required name="poFields[{{ $loop->index }}][qty]"
                                                        id="" value="{{ $detail->qty }}">
                                                </div>
                                                @php
                                                    $price = $detail->price;
                                                ...
                                                <div class="col-6 col-lg-2 form-group">
                                                    <label>Disc(%)</label>
                                                    <input type="text" class="form-control disc jumlahDisc"
                                                        required name="poFields[{{ $loop->index }}][discount]"
                                                        id="" value="{{ $detail->discount }}">
