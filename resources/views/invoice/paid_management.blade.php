        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 xl-100">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{-- <a target="_blank" class="fw-bold text-success text-nowrap">
                                {{ $return->return_number }} {{ $return->salesOrderBy->salesOrderCreditsBy->count() }}
                            </a> --}}
                        @if ($cancel_cust && $cancel_order)
                            <div class="alert alert-danger d-flex align-items-center" role="alert">
                                ...
                                <div>
                                    You must cancel payment from name: {{ $cancel_cust }}, number order:
                                    {{ $cancel_order }}
                                </div>
                            </div>
                        @endif
