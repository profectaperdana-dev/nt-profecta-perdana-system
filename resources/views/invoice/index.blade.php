        ...
        <script>
            $(document).ready(function() {
                ...
                if (filterValue == 'this_month') {
                    ...
                    var startDateString = (firstDayOfMonth.getDate() < 10 ? '0' : '') + firstDayOfMonth.getDate() +
                        '-' + ((firstDayOfMonth.getMonth() + 1) < 10 ? '0' : '') + (firstDayOfMonth.getMonth() + 1) +
                        '-' + firstDayOfMonth.getFullYear();
                    var endDateString = (lastDayOfMonth.getDate() < 10 ? '0' : '') + lastDayOfMonth.getDate() + '-' + ((
                            lastDayOfMonth.getMonth() + 1) < 10 ? '0' : '') + (lastDayOfMonth.getMonth() + 1) + '-' +
                    ...
                    $(modal_id).on('click', '.btn-reload', function() {
                        ...
                        $(modal_id).find('.productSo-edit').each(function() {
                            ...
                            let disc_rp = $(this).parent().siblings().find('.discount_rp')
                                .val();
                            let disc_cost = disc;
                            let cost_after_disc = disc_cost - disc_rp;
