                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="form-group col-12 col-lg-12">
                                                ...
                                                <input class="form-control"
                                                    value="{{ $direct->remark }} / @if ($direct->car_brand_id != null) @if (is_numeric($direct->car_brand_id) && is_numeric($direct->car_type_id))
                            {{ $direct->carBrandBy->car_brand }} {{ $direct->carTypeBy->car_type }}
                        @else
                            {{ $direct->car_brand_id }} {{ $direct->car_type_id }} @endif
@elseif($direct->motor_brand_id != null)
@if (is_numeric($direct->motor_brand_id) && is_numeric($direct->motor_type_id)) {{ $direct->motorBrandBy->name_brand }} {{ $direct->motorTypeBy->name_type }}
                        @else
                            {{ $direct->motor_brand_id }} {{ $direct->motor_type_id }} @endif
@else
{{ $direct->other }}
                    @endif"
                                                    readonly>
                                            ...
                                            @foreach ($direct->directSalesDetailBy as $item)
                                                <div class="row mx-auto py-2 rounded form-group mb-3"
                                                    ...
                                                    <div class="col-6 col-lg-2 form-group">
                                                        <label>Disc (Rp)</label>
                                                        <input type="" class="form-control" readonly
                                                            value="{{ number_format($item->discount_rp) }}"
                                                            id="">
                                                    </div>
                                                    ...
                                                    @php
                                                        ...
                                                        $harga =
                                                            (float) $retail_price - $hargadisc - $item->discount_rp;
                                                        $total = (float) $harga * $item->qty;
                                                    @endphp
                                                    <div class="col-6 col-lg-3 form-group">
                                                        <label>Amount (Rp)</label>
                                                        <input type="text" class="form-control" readonly
                                                            value="{{ number_format(round($total)) }}"
                                                            id="">
                                                    </div>
                                                    <div>
                                                        <ul class="list-group">
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="form-group col-4 col-lg-2 text-end ">
                                                <strong
                                                    class="">{{ number_format(round($direct->total_ppn)) }}</strong>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row justify-content-between">
                                    ...
                                    <ul class="dropdown-menu">
                                        @canany(['level1', 'level2'])
                                            <li>
                                                <a href="javascript:void(0)" class="dropdown-item modalRetail"
                                                    ...
                                                    data-bs-target="#editDirect{{ $direct->id }}"
                                        ...
                                        @canany(['level1'])
                                            <li><a href="" class="dropdown-item modal-btn2" data-bs-toggle="modal"
                                                    ...
                                                    data-bs-target="#delete{{ $direct->id }}"
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('create/trade_in/' . $direct->order_number) }}">Create
                                                Trade-In
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('retail/send_mail/' . $direct->id) }}">Send
                                                Email Invoice
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('return_retail/' . $direct->id) }}">Return
                                                Invoice
                                            </a>
                                        </li>
                            ...
                            <form action="{{ url('retail/' . $direct->id . '/update_retail') }}" method="POST"
                                ...
                                <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-6">
                                                        ...
                                                        <input class="form-control manual-cust"
                                                            placeholder="Enter Name" type="text"
                                                            name="cust_name_manual"
                                                ...
                                                hidden @endif>
                                                    ...
                                                    <div class="mb-3 col-sm-6">
                                                        ...
                                                        <input class="form-control phone"
                                                            ...
                                                            name="cust_phone" value="{{ $direct->cust_phone }}"
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-sm-4 ">
                                                        ...
                                                        <input class="form-control id_card"
                                                            placeholder="Enter ID Card Number" type="text"
                                                            name="cust_ktp" value="{{ $direct->cust_ktp }}"
                                                            @if (is_numeric($direct->cust_name)) readonly @endif>
                                                        <div class="form-text">*Optional</div>
                                                    </div>
                                                    <div class="mb-3 col-sm-4">
                                                        <label>Email Address</label>
                                                        <input class="form-control email_add"
                                                    ...
                                                    <div class="mb-3 col-sm-4">
                                                        ...
                                                        <input class="form-control plate"
                                                            placeholder="Enter Plate Number" type="text"
                                                            name="plate_number"
                                                            @if (is_numeric($direct->cust_name)) readonly @endif
                                                ...
                                                <div class="mb-3 col-sm-4 vehicle"
                                                    ...
                                                    <select class="form-control select2" name="vehicle"
                                                        ...
                                                        <option value="Motocycle"
                                                            @if ($direct->motor_brand_id != null) selected @endif>
                                                            Motocycle
                                                        </option>
                                                        <option value="Other"
                                            ...
                                            <div class="row" id="car" hidden>
                                                <div class="mb-3 col-sm-4">
                                                    ...
                                                    <select class="form-control select2 car-brand"
                                                        name="car_brand_id">
                                                ...
                                                <div class="mb-3 col-12 other-car" id="" hidden>
                                                    ...
                                                    <input type="text" placeholder="Enter Other Car Type"
                                                        name="other_car" class="form-control other_car_input">
                                                </div>
                                            </div>
                                            <div class="row" id="motor" hidden>
                                                <div class="mb-3 col-sm-6">
                                                    <label>Motocycle Brand</label>
                                                    <select class="form-control select2 motor-brand"
                                                        name="motor_brand_id">
                                                        <option selected="" value="">Choose...</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-sm-4">
                                                    ...
                                                    <input class="form-control" placeholder="Enter Remark"
                                                        type="text" name="remark" value="{{ $direct->remark }}">
                                                </div>
                                                <div class="mb-3 col-sm-4">
                                    ...
                                    <div class="mb-3 row box-select-all justify-content-end">
                                        <button type="button"
                                            class="col-3 col-xl-1 me-3 btn btn-sm btn-primary addRetail"
                                            id="addRetail">+</button>
                                    </div>
                                    <div class="col-md-12">
                                                        ...
                                                        @foreach ($item->directSalesCodeBy as $code)
                                                            <div class="col-6 col-lg-3 form-group first-code">
                                                                <input type="text" class="form-control" required
                                                                    ...
                                                                    value="{{ $code->product_code }}"
                                                                    id="">
                                                                <input type="hidden" class="item-index"
                                                                    value="{{ $loop->parent->index }}"
                                                                    id="">
